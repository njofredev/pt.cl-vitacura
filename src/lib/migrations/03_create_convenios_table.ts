...
async function migrate() {
  ...
  try {
    ...
    const seedConvenios = [
      ...
      { empresa: 'FUNDACIÓN EDUCACIONAL LO BARNECHEA', fecha: '2025-10-22', descuento: '0%', center: 'CESFAM Lo Barnechea' },
      ...
      { empresa: 'Municipalidad Las Condes: CESFAM Dr. Aníbal Ariztía', fecha: '2025-01-21', descuento: '15%', center: 'Consultorio Dr. Aníbal Ariztía' },
      { empresa: 'Policlinico Tabancura: Convenio colaboradores Policlinico Tabancura', fecha: '2025-10-30', descuento: '0%', center: 'Policlinico Tabancura' },
      { empresa: 'POLICLINICO TABANCURA: PACIENTE-HISTÓRICO', fecha: '2024-11-02', descuento: '0%', center: 'Policlinico Tabancura' },
      { empresa: 'POLICLINICO TABANCURA: BENEFICIARIOS', fecha: '2022-09-28', descuento: '0%', center: 'Policlinico Tabancura' },
