      ...
      const res = await pool.query(`
        WITH global_cases AS (
          SELECT c.id, p.rut, p.first_names, p.last_names, p.nationality, p.birth_date, p.commune, p.email, p.mobile, 
                 ...
                 c.status, c.observations, c.created_at, c.dental_count, c.xray_count, c.status_history, c.attachment_path,
                 c.epicrisis_diagnosis, c.epicrisis_indications, c.epicrisis_at,
